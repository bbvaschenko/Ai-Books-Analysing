...
section_tags = [  # Объединённый уровень 1 + 2
...
concept_tags = [  # Термины (бывший уровень 3)
...
difficulty_tags = [  # Сложность (бывший уровень 4)
...
if __name__ == "__main__":
    analyze_pdf("978-5-7996-1779-0_2016.pdf")  # Замените на свой путь к PDF
